  ...
  handler: async (ctx, args): Promise<Id<'links'>> => {
    ...
    if (existingLink) {
      ...
      await ctx.db.patch(existingLink._id, {
        title: args.title ?? existingLink.title,
        description: args.description ?? existingLink.description,
        thumbnailUrl: args.thumbnailUrl ?? existingLink.thumbnailUrl,
        tags: args.tags ?? existingLink.tags,
        readingTime: args.readingTime ?? existingLink.readingTime,
        source: args.source ?? existingLink.source,
        originalApp: args.originalApp ?? existingLink.originalApp,
        updatedAt: now,
      });
